...
function addWords() {
    let table = document.getElementById("myTable02");
...
function loadTable() {
    let html = localStorage.getItem("myTable02");
    if (html) {
      document.getElementById("myTable02").outerHTML = html;
    }
}
...
function saveTable() {
    ...
    localStorage.setItem("myTable02", html);
  }

function editRow(row) {
    let rowIndex = row.parentNode.parentNode.rowIndex;
    let cell0 = document.getElementById("myTable02").rows[rowIndex].cells[0];
    let cell1 = document.getElementById("myTable02").rows[rowIndex].cells[1];
    let cell2 = document.getElementById("myTable02").rows[rowIndex].cells[2];
    let cell3 = document.getElementById("myTable02").rows[rowIndex].cells[3];
    let cell4 = document.getElementById("myTable02").rows[rowIndex].cells[4];
...
function deleteRow(row) {
    ...
    document.getElementById("myTable02").deleteRow(d);
    saveTable();
  }
